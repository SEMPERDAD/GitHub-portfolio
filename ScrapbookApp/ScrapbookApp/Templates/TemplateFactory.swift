...
/// Defines all built-in page templates.
/// Call `template.makePage(title:)` to stamp a pre-positioned layout onto a new page.
...
extension PageTemplate {
    ...
    /// Travel — Postcards, stamps, tilted polaroids (Paris / Italy style)
    ...
    /// Family — 4-photo grid, handwritten captions (warm & cozy)
    ...
    /// Seasonal — Overlapping collage, leaf decoratives (autumn-inspired)
    ...
    /// Minimal — Clean lines, generous white space (modern & geometric)
    ...
    /// Collage — 6 overlapping photos, magazine style (bold & dynamic)
    ...
    /// Journal — Text-heavy with photo accents (diary / notebook feel)
    ...
    /// Freeform — Blank canvas, complete freedom
