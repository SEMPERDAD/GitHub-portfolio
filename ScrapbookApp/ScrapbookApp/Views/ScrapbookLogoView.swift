...
/// Use `ScrapbookLogoView(size: 120)` for app-preview hero art.
struct ScrapbookLogoView: View {
    ...
    var body: some View {
        ZStack {
            ...
            // Tiny star — bottom-right corner
            Image(systemName: "star.fill")
                .font(.system(size: size * 0.07))
                .foregroundStyle(.white.opacity(0.40))
                .offset(x: size * 0.34, y: size * 0.34)

            // Back page — rotated open, peeks behind book
            ...
            // Heart accent — lower-left of left page
            ...
            ZStack {
                ...
                // Photo gradient inside polaroid
                LinearGradient(
                    colors: [
                        Color(red: 0.81, green: 0.73, blue: 0.94),
